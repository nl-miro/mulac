...
pub(crate) mod models {
    ...
    /// The stale-event sweep SQL appends into the `{errors}` path directly.
    #[derive(
...
mod consumer_impl {
    ...
    impl EventProcessPort for EventConsumerStorage {
        ...
        fn failed(
            ...
            conn.transaction::<(), diesel::result::Error, _>(|conn| {
                ...
                .returning((event_entries::attempts, event_entries::extra_info))
                ...
                diesel::update(event_entries::table.find(id))
                    .set((
                        ...
                        event_entries::updated_at.eq(diesel::dsl::now),
                        event_entries::extra_info.eq(extra_info),
                    ))
                    .execute(conn)?;
    ...
    impl EventSweepPort for EventConsumerStorage {
        fn sweep(&self, spec: &StaleEventSpec) -> Result<u64, EventError> {
            ...
            .bind::<diesel::sql_types::Text, _>("event reservation timed out") // $4
            .bind::<Int4, _>(i32::from(EventStatus::Reserved)) // $5
